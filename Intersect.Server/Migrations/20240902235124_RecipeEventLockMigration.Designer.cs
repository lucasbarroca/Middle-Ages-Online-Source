...
namespace Intersect.Server.Migrations
{
    ...
    [Migration("20240902235124_RecipeEventLockMigration")]
    partial class RecipeEventLockMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intersect.Server.Core.Games.ClanWars.ClanWarInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<long>("TimeEnded");

                    b.Property<long>("TimeStarted");

                    b.Property<Guid>("WinningGuildId");
            ...
            modelBuilder.Entity("Intersect.Server.Core.Games.ClanWars.ClanWarParticipant", b =>
                {
                    ...
                    b.HasKey("ClanWarId", "GuildId");

                    b.ToTable("Clan_War_Participants");
                });

            modelBuilder.Entity("Intersect.Server.Core.Games.ClanWars.TerritoryInstance", b =>
                {
            ...
            modelBuilder.Entity("Intersect.Server.Database.PlayerData.Players.PermabuffInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Intersect.Server.Database.PlayerData.Players.PlayerLoadout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("HotbarSlotsJson")
                        .HasColumnName("HotbarSlots");
            ...
            modelBuilder.Entity("Intersect.Server.Entities.Player", b =>
                {
                    ...
                    b.Property<bool>("CraftingDataBackfilled");

                    b.Property<string>("CraftingWishlistJson")
                        .HasColumnName("CraftingWishlist");
                    ...
                    b.Property<bool>("DisableChampionSpawns");

                    b.Property<bool>("EnhancementTutorialDone");
                    ...
                    b.Property<int>("ItemSkillPoints");
                    ...
                    b.Property<int>("LevelSkillPoints")
                        .HasColumnName("SkillPointTotal");

                    b.Property<Guid>("MapId");

                    b.Property<byte>("MeleeEndDir");

                    b.Property<Guid>("MeleeEndMapId");

                    b.Property<int>("MeleeEndX");

                    b.Property<int>("MeleeEndY");
                    ...
                    b.Property<string>("PermabuffedStatsJson")
                        .HasColumnName("PermabuffedStats");

                    b.Property<string>("PermabuffedVitalsJson")
                        .HasColumnName("PermabuffedVitals");
            ...
            modelBuilder.Entity("Intersect.Server.Core.Games.ClanWars.ClanWarParticipant", b =>
                {
                    b.HasOne("Intersect.Server.Core.Games.ClanWars.ClanWarInstance", "ClanWar")
                        .WithMany("Participants")
                        .HasForeignKey("ClanWarId")
